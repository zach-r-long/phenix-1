...
type UserSpec struct {
	...
	Password  string    `yaml:"password" json:"password,omitempty" structs:"password" mapstructure:"password"`
	...
	Tokens map[string]string `yaml:"tokens" json:"tokens,omitempty" structs:"tokens" mapstructure:"tokens"`
}
